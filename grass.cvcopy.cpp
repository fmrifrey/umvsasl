 ...
 * grass.cvcopy.cpp 
 *
 * This file is automatically generated by the '/ESE_RX28.0_R04_UHP3T/psd/bin/contigCVs' script.
 ...
 * these variables.
 *
 * Generated on Wed Mar 22 21:16:02 2023 
 */

#ifndef h_grass_cvcopy_cpp
#define h_grass_cvcopy_cpp

#include "cvcopy_proto.h"

#if defined(PSD_HW) && defined(HOST_TGT)
/* Include endian converter functions */
#include "grass.cnvendian.globalvar.h"
#include "grass.cnvendian.c"
...
static const cvcopy_table_entry cvcopy_table[] = {
    ...
    { &opdnr, sizeof(opdnr) },
    { &rhdnr_enabled, sizeof(rhdnr_enabled) },
    { &rhdnr_control, sizeof(rhdnr_control) },
    { &rhdnr_snr_ratio, sizeof(rhdnr_snr_ratio) },
    { &rhdnr_noise_ratio, sizeof(rhdnr_noise_ratio) },
    { &rhdnr_signal_threshold_ratio, sizeof(rhdnr_signal_threshold_ratio) },
    { &rhdnr_background_noise_ratio, sizeof(rhdnr_background_noise_ratio) },
    { &rhdnr_edge_ratio, sizeof(rhdnr_edge_ratio) },
    { &rhdnr_sharpness_ratio, sizeof(rhdnr_sharpness_ratio) },
    { &rhdnr_iteration_end_ratio, sizeof(rhdnr_iteration_end_ratio) },
    { &rhdnr_amplitude_ratio, sizeof(rhdnr_amplitude_ratio) },
    { &rhdnr_amplitude_scale_factor, sizeof(rhdnr_amplitude_scale_factor) },
    ...
    { &rhrc_cardiac_ctrl, sizeof(rhrc_cardiac_ctrl) },
    ...
    { &ihmavric_bins, sizeof(ihmavric_bins) },
    ...
    { &rhwnd_scale, sizeof(rhwnd_scale) },
    ...
    { &rh_airiq_config, sizeof(rh_airiq_config) },
    { &rh_airiq_level_a, sizeof(rh_airiq_level_a) },
    { &rh_airiq_level_b, sizeof(rh_airiq_level_b) },
    { &rh_airiq_win_r, sizeof(rh_airiq_win_r) },
    { &rh_airiq_win_w, sizeof(rh_airiq_win_w) },
    ...
    { &mavricNumBinsCal, sizeof(mavricNumBinsCal) },
    { &mavricCalDone, sizeof(mavricCalDone) },
    { &mavricCalFlag, sizeof(mavricCalFlag) },
    { &enableMapTg, sizeof(enableMapTg) },
    { &cfmaxnbtxchannels, sizeof(cfmaxnbtxchannels) },
    { &cfmagnettype, sizeof(cfmagnettype) },
    { &rhadaptive_nex_groups, sizeof(rhadaptive_nex_groups) },
    { &opairecon, sizeof(opairecon) },
    ...
    { &disable_amplifier_unblank, sizeof(disable_amplifier_unblank) },
    ...
    { &gLimitForExtHighResOpt, sizeof(gLimitForExtHighResOpt) },
    { &cal_based_optimal_recon_enabled, sizeof(cal_based_optimal_recon_enabled) },
    { &act_tr, sizeof(act_tr) },
    { &AutoParam_flag, sizeof(AutoParam_flag) },
    ...
    { &cal_sr_derate, sizeof(cal_sr_derate) },
    ...
    { &a_gyr1, sizeof(a_gyr1) },
    { &a_gyr1a, sizeof(a_gyr1a) },
    { &a_gyr1b, sizeof(a_gyr1b) },
    { &ia_gyr1, sizeof(ia_gyr1) },
    { &ia_gyr1wa, sizeof(ia_gyr1wa) },
    { &ia_gyr1wb, sizeof(ia_gyr1wb) },
    { &pw_gyr1a, sizeof(pw_gyr1a) },
    { &pw_gyr1d, sizeof(pw_gyr1d) },
    { &pw_gyr1, sizeof(pw_gyr1) },
    { &wg_gyr1, sizeof(wg_gyr1) },
    { &a_gzk, sizeof(a_gzk) },
    ...
    { &PSattribute_codeMeaning, sizeof(PSattribute_codeMeaning) },
...
void cvcopy_cnv_endian( char * data )
{
    ...
    cv_cnv_endian_opdnr( data );
    data += sizeof(opdnr);

    cv_cnv_endian_rhdnr_enabled( data );
    data += sizeof(rhdnr_enabled);

    cv_cnv_endian_rhdnr_control( data );
    data += sizeof(rhdnr_control);

    cv_cnv_endian_rhdnr_snr_ratio( data );
    data += sizeof(rhdnr_snr_ratio);

    cv_cnv_endian_rhdnr_noise_ratio( data );
    data += sizeof(rhdnr_noise_ratio);

    cv_cnv_endian_rhdnr_signal_threshold_ratio( data );
    data += sizeof(rhdnr_signal_threshold_ratio);

    cv_cnv_endian_rhdnr_background_noise_ratio( data );
    data += sizeof(rhdnr_background_noise_ratio);

    cv_cnv_endian_rhdnr_edge_ratio( data );
    data += sizeof(rhdnr_edge_ratio);

    cv_cnv_endian_rhdnr_sharpness_ratio( data );
    data += sizeof(rhdnr_sharpness_ratio);

    cv_cnv_endian_rhdnr_iteration_end_ratio( data );
    data += sizeof(rhdnr_iteration_end_ratio);

    cv_cnv_endian_rhdnr_amplitude_ratio( data );
    data += sizeof(rhdnr_amplitude_ratio);

    cv_cnv_endian_rhdnr_amplitude_scale_factor( data );
    data += sizeof(rhdnr_amplitude_scale_factor);
    ...
    cv_cnv_endian_rhrc_cardiac_ctrl( data );
    data += sizeof(rhrc_cardiac_ctrl);
    ...
    cv_cnv_endian_ihmavric_bins( data );
    data += sizeof(ihmavric_bins);
    ...
    cv_cnv_endian_rhwnd_scale( data );
    data += sizeof(rhwnd_scale);
    ...
    cv_cnv_endian_rh_airiq_config( data );
    data += sizeof(rh_airiq_config);

    cv_cnv_endian_rh_airiq_level_a( data );
    data += sizeof(rh_airiq_level_a);

    cv_cnv_endian_rh_airiq_level_b( data );
    data += sizeof(rh_airiq_level_b);

    cv_cnv_endian_rh_airiq_win_r( data );
    data += sizeof(rh_airiq_win_r);

    cv_cnv_endian_rh_airiq_win_w( data );
    data += sizeof(rh_airiq_win_w);
    ...
    cv_cnv_endian_mavricNumBinsCal( data );
    data += sizeof(mavricNumBinsCal);

    cv_cnv_endian_mavricCalDone( data );
    data += sizeof(mavricCalDone);

    cv_cnv_endian_mavricCalFlag( data );
    data += sizeof(mavricCalFlag);

    cv_cnv_endian_enableMapTg( data );
    data += sizeof(enableMapTg);

    cv_cnv_endian_cfmaxnbtxchannels( data );
    data += sizeof(cfmaxnbtxchannels);

    cv_cnv_endian_cfmagnettype( data );
    data += sizeof(cfmagnettype);

    cv_cnv_endian_rhadaptive_nex_groups( data );
    data += sizeof(rhadaptive_nex_groups);

    cv_cnv_endian_opairecon( data );
    data += sizeof(opairecon);
    ...
    cv_cnv_endian_disable_amplifier_unblank( data );
    data += sizeof(disable_amplifier_unblank);
    ...
    cv_cnv_endian_gLimitForExtHighResOpt( data );
    data += sizeof(gLimitForExtHighResOpt);

    cv_cnv_endian_cal_based_optimal_recon_enabled( data );
    data += sizeof(cal_based_optimal_recon_enabled);

    cv_cnv_endian_act_tr( data );
    data += sizeof(act_tr);

    cv_cnv_endian_AutoParam_flag( data );
    data += sizeof(AutoParam_flag);
    ...
    cv_cnv_endian_yfov_aspect( data );
    data += sizeof(yfov_aspect);
    ...
    cv_cnv_endian_nechoes( data );
    data += sizeof(nechoes);

    cv_cnv_endian_ntrains( data );
    data += sizeof(ntrains);

    cv_cnv_endian_nnav( data );
    data += sizeof(nnav);

    cv_cnv_endian_R_accel( data );
    data += sizeof(R_accel);

    cv_cnv_endian_THETA_accel( data );
    data += sizeof(THETA_accel);

    cv_cnv_endian_sptype2d( data );
    data += sizeof(sptype2d);

    cv_cnv_endian_sptype3d( data );
    data += sizeof(sptype3d);

    cv_cnv_endian_SLEWMAX( data );
    data += sizeof(SLEWMAX);

    cv_cnv_endian_GMAX( data );
    data += sizeof(GMAX);
    ...
    cv_cnv_endian_cal_sr_derate( data );
    data += sizeof(cal_sr_derate);
    ...
    cv_cnv_endian_pw_gxwa( data );
    data += sizeof(pw_gxwa);

    cv_cnv_endian_pw_gxwd( data );
    data += sizeof(pw_gxwd);

    cv_cnv_endian_pw_gxw( data );
    data += sizeof(pw_gxw);

    cv_cnv_endian_wg_gxw( data );
    data += sizeof(wg_gxw);
    ...
    cv_cnv_endian_a_gyr1( data );
    data += sizeof(a_gyr1);

    cv_cnv_endian_a_gyr1a( data );
    data += sizeof(a_gyr1a);

    cv_cnv_endian_a_gyr1b( data );
    data += sizeof(a_gyr1b);

    cv_cnv_endian_ia_gyr1( data );
    data += sizeof(ia_gyr1);

    cv_cnv_endian_ia_gyr1wa( data );
    data += sizeof(ia_gyr1wa);

    cv_cnv_endian_ia_gyr1wb( data );
    data += sizeof(ia_gyr1wb);

    cv_cnv_endian_pw_gyr1a( data );
    data += sizeof(pw_gyr1a);

    cv_cnv_endian_pw_gyr1d( data );
    data += sizeof(pw_gyr1d);

    cv_cnv_endian_pw_gyr1( data );
    data += sizeof(pw_gyr1);

    cv_cnv_endian_wg_gyr1( data );
    data += sizeof(wg_gyr1);
    ...
    cv_cnv_endian_PSattribute_codeMeaning( data );
    data += sizeof(PSattribute_codeMeaning);
...
static const char * cvcopy_table_names[] = {
    ...
    "rhdnr_snr_ratio", 
    "rhdnr_noise_ratio", 
    "rhdnr_signal_threshold_ratio", 
    "rhdnr_background_noise_ratio", 
    "rhdnr_edge_ratio", 
    "rhdnr_sharpness_ratio", 
    "rhdnr_iteration_end_ratio", 
    "rhdnr_amplitude_ratio", 
    "rhdnr_amplitude_scale_factor", 
    "opweight", 
    "oplandmark", 
    "optabent", 
    "opentry", 
    ...
    "gLimitForExtHighResOpt", 
    "cal_based_optimal_recon_enabled", 
    "act_tr", 
    "AutoParam_flag", 
    "autolock", 
    "blank", 
