...
if rdbm_rev == 27.000 
  ...
  a.saveOriginalImage = fread(my_file, 1, 'int32');
  a.cardt1map_hb_pattern = fread(my_file, 1, 'int32');
  a.distortionCorrection = fread(my_file, 1, 'int32');
  a.ihdistcorr = fread(my_file, 1, 'int32');
  a.ihpepolar = fread(my_file, 1, 'int32');
  for id = 1 : 9
    a.int_padding2(id) = fread(my_file, 1, 'int32');
  end
  a.imatrix_X = fread(my_file, 1, 'int16');
...
if rdbm_rev == 28.000 
  ...
  a.put_in_database = fread(my_file, 1, 'int16');
  a.scout_scan = fread(my_file, 1, 'int16');
  a.num_bins = fread(my_file, 1, 'int16');
  for id = 1 : 27
    a.short_padding(id) = fread(my_file, 1, 'int16');
  end
  a.psdname = freadc(my_file, 33);
...
if rdbm_rev == 28.002 
  ...
  a.ihpepolar = fread(my_file, 1, 'int32');
  a.dst = fread(my_file, 1, 'int32');
  a.dlReconLevel = fread(my_file, 1, 'int32');
  for id = 1 : 7
    a.int_padding2(id) = fread(my_file, 1, 'int32');
  end
  a.imatrix_X = fread(my_file, 1, 'int16');
...
if rdbm_rev >= 28.003 
  ...
  a.seriesMaxTimeLowSAR = fread(my_file, 1, 'float32');
  a.npwFactor = fread(my_file, 1, 'float32');
  a.nswFactor = fread(my_file, 1, 'float32');
  a.dim_Z = fread(my_file, 1, 'float32');
  for id = 1 : 6
    a.float_padding(id) = fread(my_file, 1, 'float32');
  end
  a.cal_fldstr = fread(my_file, 1, 'uint32');
