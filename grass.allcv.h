...
#ifndef h_grass_allcv_h
#define h_grass_allcv_h
...
;
/* ********************************
   Bit patterns for rhdnr_control
   ------------------------------
   RDB_DNR_DN       1
   bit 0  Set if DeNoise
   RDB_DNR_DR      2
   bit 1  Set if De-RInging
   ****************************** */
...
/* mavric bins info for DICOM tag */
...
int pw_gy1_tot = 0;       /* temp time accumulation */
float yfov_aspect = 1.0 ;
int endview_iamp = 0; /* last instruction phase amp */
float endview_scale = 0; /* ratio of last instruction amp to maximum value */
