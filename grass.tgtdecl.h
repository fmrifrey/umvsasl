...
#ifndef h_grass_tgtdecl_h
#define h_grass_tgtdecl_h
...
double pscCF;  /* CF center frequency (in 1/10 of Hz) */
int pscTG;  /* TG transmit gain (in 1/10 of dB) */
 ...
 */
  ...
  WF_PULSE gyr1a = INITPULSE;
  WF_PULSE gyr1 = INITPULSE;
  WF_PULSE gyr1d = INITPULSE;
